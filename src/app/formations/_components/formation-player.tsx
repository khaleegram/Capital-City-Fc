    ...
    return (
        <div className="relative group/player flex flex-col items-center justify-center text-center w-full h-full">
            ...
            <div className="mt-1.5 text-center">
                 <p className="text-white text-[10px] sm:text-xs font-bold leading-tight bg-black/60 px-1.5 py-0.5 rounded-sm shadow-lg truncate max-w-[60px] sm:max-w-[80px]">{player.name}</p>
            </div>
        </div>
    );
}

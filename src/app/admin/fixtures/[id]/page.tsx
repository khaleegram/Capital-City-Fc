...
import { teamLogoUrl } from "@/lib/brand"
import { useAuth } from "@/hooks/use-auth"
import { FormationDisplay } from "@/app/admin/formations/_components/formation-display"
...
export default function FixtureDetailsPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    const fixtureDate = toDate(fixture.date) ?? new Date();
                ...
                <CardContent className="flex items-center justify-center text-center">
                    <div className="flex-1 flex items-center justify-end gap-4">
                        ...
                        <Avatar className="h-16 w-16">
                            <AvatarImage src={teamLogoUrl(teamProfile.logoUrl)} alt={teamProfile.name} data-ai-hint="team logo" />

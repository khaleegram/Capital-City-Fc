  ...
  useEffect(() => {
    if (player) {
      reset({
        ...
        readyForNextStep: !!player.readyForNextStep,
  ...
  const onSubmit = async (data: PlayerFormData) => {
    ...
    try {
      ...
      if (data.image && data.image[0]) {
        imageUrl = await uploadPlayerImage(data.image[0])
      }
      ...
      const playerPayload: Partial<Player> = {
        ...
        nationality: restOfData.nationality,
        currentClub: restOfData.currentClub,
        strengths: restOfData.strengths,
        readyForNextStep: restOfData.readyForNextStep,
        published: restOfData.published,
      };
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
                    ...
                    <div>
                      ...
                      <Input id="cohort" placeholder="2025/26" {...register("cohort")} />
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      {errors.heightCm && <p className="text-sm text-destructive">Enter a height between 100 and 230 cm.</p>}
                    </div>
                    <div>
                  ...
                  <div className="space-y-1.5">
                    ...
                    <Controller
                      name="strengths"
                      control={control}
                      render={({ field }) => <ListInput value={field.value} onChange={field.onChange} placeholder="e.g. Aerial duels, Press resistance" />}
                    />
                  </div>
                  <div className="grid gap-3 sm:grid-cols-2">
                    <Controller
                      name="readyForNextStep"
                      control={control}
                      render={({ field }) => <SwitchRow label="Ready for next step" hint="Shows the badge scouts look for." checked={field.value} onChange={field.onChange} />}
                    />
                    <Controller
                      name="published"
                      control={control}
                      render={({ field }) => <SwitchRow label="Show on public site" checked={field.value} onChange={field.onChange} />}
                    />
                  </div>
                </div>
                <Separator />

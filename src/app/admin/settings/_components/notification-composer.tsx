...
export function NotificationComposer() {
    ...
    const onSubmit = async (data: NotificationFormData) => {
        ...
        try {
            ...
            // Surface the real reason: the usual cause is a missing server credential.
            toast({
                variant: "destructive",
                title: "Error",
                description: error instanceof Error ? error.message : "Could not send the notification.",
            });
        } finally {
